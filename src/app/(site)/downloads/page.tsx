                ...
                <div className="container mx-auto px-4">
                    ...
                    <div id="linha-versa" className="max-w-6xl mx-auto mt-24 scroll-mt-32">
                        <div className="text-center mb-12">
                            ...
                            <h2 className="text-3xl md:text-5xl font-black text-industrial-950 uppercase tracking-tighter leading-none mb-4">
                                Desenhos <span className="text-accent-premium">Técnicos</span>
                            </h2>
                            <p className="text-industrial-500 text-base md:text-lg font-medium max-w-2xl mx-auto">
                                Desenho técnico dimensional por altura dos postes decorativos Girafa LED, em PDF.
                            </p>
                        </div>
                    ...
                    <div id="linha-nexo" className="max-w-6xl mx-auto mt-24 scroll-mt-32">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-industrial-500 text-base md:text-lg font-medium max-w-2xl mx-auto">
                                Ficha técnica completa dos acessórios que conectam o poste ao projeto: braços, suportes, cruzetas e chumbadores.
                            </p>
                        </div>

                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                            {NEXO_DATASHEETS.map((item) => (
                                <div key={item.codigo} className="bg-white border border-industrial-200 hover:border-accent-premium transition-all duration-300 shadow-sm hover:shadow-xl flex flex-col">
                                    <div className="p-6 border-b border-industrial-100">
                                        <div className="bg-accent-premium text-black inline-block px-3 py-1 text-[10px] font-black uppercase tracking-widest mb-3">
                                            {item.codigo}
                                        </div>
