                ...
                <div className="container mx-auto px-4">
                    ...
                    <div id="linha-civis" className="max-w-6xl mx-auto mt-24 scroll-mt-32">
                        <div className="text-center mb-12">
                            ...
                            <h2 className="text-3xl md:text-5xl font-black text-industrial-950 uppercase tracking-tighter leading-none mb-4">
                                Mastros <span className="text-accent-premium">para Bandeira</span>
                            </h2>
                            <p className="text-industrial-500 text-base md:text-lg font-medium max-w-2xl mx-auto">
                                Mastros telecônicos em aço galvanizado a fogo, de 6 a 12 metros, com roldana, arruela-guia
                                e cleat de amarração. Datasheet com guia bandeira × mastro e desenho técnico por altura.
                            </p>
                        </div>
                                                ...
                                                <div key={grupo.mount} className="space-y-3">
                                                    ...
                                                    <div className="flex flex-wrap gap-2">
                                                        {grupo.alturas.map((altura) => (
                                                            <a
                                                                key={altura}
                                                                href={desenhoMastroHref(altura, grupo.mount)}
                                                                download
                                                                className="px-3 py-1.5 bg-industrial-50 border border-industrial-200 text-[11px] font-black text-industrial-700 uppercase tracking-widest hover:border-industrial-900 hover:text-industrial-950 transition-colors rounded-md"
                                                            >
                                                                {altura}m
