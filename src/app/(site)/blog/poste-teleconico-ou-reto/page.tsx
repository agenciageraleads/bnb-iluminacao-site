...
const pageDescription =
    "Entenda a diferenca entre poste teleconico, poste reto, curvo simples e curvo duplo para cotar o modelo certo conforme aplicacao e luminaria."
const heroImage = "/images/produtos/poste-reto-avenida-dia.png"
const whatsappMessage =
    "Ola, vim pelo guia de poste teleconico ou reto e quero ajuda para definir o modelo correto no orcamento."

export const metadata: Metadata = {
    title: {
        absolute: "Poste Teleconico ou Reto | Guia Tecnico B&B",
    },
    ...
    openGraph: {
        title: "Poste Teleconico ou Reto | Guia Tecnico B&B",
        description: pageDescription,
        url: pageUrl,
        type: "article",
        images: [
                ...
                <div className="container relative z-10 mx-auto px-4 pb-20 pt-12 md:pb-28">
                    <div className="max-w-4xl">
                        ...
                        <h1 className="max-w-4xl text-4xl font-black uppercase leading-[0.95] tracking-tight text-white md:text-6xl lg:text-7xl">
                            Poste Teleconico ou Reto: Entenda Antes de Cotar
                        </h1>
                        <p className="mt-8 max-w-3xl text-base font-medium leading-relaxed text-industrial-200 md:text-xl">
                            Em muitos pedidos, teleconico e reto aparecem como se fossem opostos. Na pratica, eles podem
                            descrever partes diferentes da especificacao. Este guia ajuda a nomear o modelo certo antes
                            de pedir preco.
                        </p>
