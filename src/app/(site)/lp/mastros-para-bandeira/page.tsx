        ...
        <main className="min-h-screen bg-white">
            ...
            <header className="bg-white border-b border-industrial-200 shadow-sm py-3 sticky top-0 z-50">
                <div className="container mx-auto px-4 flex justify-between items-center h-14">
                    ...
                    <a
                        href="https://wa.me/5562981767802?text=Olá, quero um orçamento para mastros de bandeira."
                        target="_blank"
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                        ...
                        <div className="flex-1 text-center lg:text-left">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                                <a
                                    href="https://wa.me/5562981767802?text=Olá, vim pela página de mastros para bandeira e quero solicitar um orçamento."
                                    target="_blank"
                                    rel="noopener noreferrer"
            ...
            <section className="py-20 md:py-32 bg-accent-premium relative overflow-hidden" aria-labelledby="cta-mastros-heading">
                <div className="container mx-auto px-4 text-center space-y-8 relative z-10">
                    ...
                    <a
                        href="https://wa.me/5562981767802?text=Olá! Quero um orçamento para mastros de bandeira. Podem me ajudar?"
                        target="_blank"
                        rel="noopener noreferrer"
