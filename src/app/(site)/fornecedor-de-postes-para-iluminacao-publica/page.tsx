...
const config = p0CommercialPages.fornecedorIluminacaoPublica

export const metadata: Metadata = {
    title: { absolute: "Fornecedor de Postes para Iluminacao Publica | B&B" },
    description: config.description,
    alternates: { canonical: config.pageUrl },
    openGraph: {
        title: "Fornecedor de Postes para Iluminacao Publica | B&B",
        description: config.description,
        url: config.pageUrl,
        type: "website",
...
export default function FornecedorDePostesParaIluminacaoPublicaPage() {
