            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {benefits.map((benefit, index) => (
                        <div key={index} className="bg-gradient-to-br from-industrial-900 to-industrial-800/80 border-l-4 border-l-accent-premium p-8 hover:-translate-y-1 hover:shadow-xl hover:shadow-accent-premium/5 transition-all duration-300 group rounded-2xl">
