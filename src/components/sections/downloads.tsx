            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row items-center justify-between gap-12 max-w-6xl mx-auto">
                    <div className="flex-1 space-y-6">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-accent-premium/10 border border-accent-premium/20 text-accent-premium text-xs font-bold tracking-widest uppercase rounded-md">
                            Arquivos Técnicos
                        </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 w-full md:w-auto">
                        {displayedCatalogs.length > 0 ? (
                            displayedCatalogs.map((catalog) => (
                                <div key={catalog.id} className="bg-industrial-950 p-8 border border-industrial-800 hover:border-accent-premium transition-colors space-y-6 group w-full sm:w-72 rounded-2xl">
                                    <div className="size-16 bg-industrial-900 border border-industrial-800 flex items-center justify-center group-hover:bg-accent-premium transition-colors rounded-lg">
                                    ...
                                    <Button asChild className="w-full bg-industrial-800 text-white hover:bg-accent-premium hover:text-black font-bold uppercase tracking-widest rounded-lg gap-2">
                                        <Link href="/downloads">
                            ...
                            [1, 2].map((i) => (
                                <div key={i} className="bg-industrial-950 p-8 border border-industrial-800 opacity-50 space-y-6 w-full sm:w-72 rounded-2xl">
                                    <div className="size-16 bg-industrial-900 border border-industrial-800 flex items-center justify-center rounded-lg">
                                    ...
                                    <Button disabled className="w-full bg-industrial-800 text-industrial-600 font-bold uppercase tracking-widest rounded-lg gap-2 cursor-not-allowed">
                                        <Download className="size-4" />
                                        Indisponível
                                    </Button>
                                </div>
