                    ...
                    <div className="flex flex-col sm:flex-row gap-6 w-full md:w-auto">
                        {displayedCatalogs.length > 0 ? (
                            displayedCatalogs.map((catalog) => (
                                <div key={catalog.id} className="bg-industrial-950 p-8 border border-industrial-800 hover:border-accent-premium transition-colors space-y-6 group w-full sm:w-72 rounded-lg">
                                    <div className="size-16 bg-industrial-900 border border-industrial-800 flex items-center justify-center group-hover:bg-accent-premium transition-colors rounded-md">
                                    ...
                                    <Button asChild className="w-full bg-industrial-800 text-white hover:bg-accent-premium hover:text-black font-bold uppercase tracking-widest rounded-md gap-2">
                                        <Link href="/downloads">
                            ...
                            [1, 2].map((i) => (
                                <div key={i} className="bg-industrial-950 p-8 border border-industrial-800 opacity-50 space-y-6 w-full sm:w-72 rounded-lg">
                                    <div className="size-16 bg-industrial-900 border border-industrial-800 flex items-center justify-center rounded-md">
                                    ...
                                    <Button disabled className="w-full bg-industrial-800 text-industrial-600 font-bold uppercase tracking-widest rounded-md gap-2 cursor-not-allowed">
                                        <Download className="size-4" />
                                        Indisponível
                                    </Button>
                                </div>
