...
const paths = [
  ...
  '/solucoes',
  '/solucoes/construcao-privada',
  '/solucoes/setor-publico',
  '/solucoes/iluminacao-publica-ppp',
  '/solucoes/infraestrutura',
  '/solucoes/revendas',
  '/solucoes/projetistas',
  '/solucoes/industria',
  ...
  '/produtos',
  '/obras',
  '/obras/postes-para-pracas-centralina-mg',
  '/obras/postes-para-quadras-esportivas-arapora-go',
  '/obras/postes-para-area-hospitalar-goiania-go',
  '/blog',
